...
# ─────────────────────────────────────────────
    ...
    with tab_leitor:
        st.markdown('''<div style="background:#1e3a5f;color:#fff;padding:13px 18px;
        border-radius:10px;border-left:5px solid #3b82f6;font-weight:600;margin:8px 0;">
        ℹ️ Conecte um leitor USB (plug &amp; play — funciona como teclado). Escaneie o código e
        clique em Buscar. Se o produto já existir, registra entrada direto. Se for novo, abre
        ...
        with col_modo2:
            ...
            💡 Leitores USB digitam o código + Enter automaticamente!
            </div>''', unsafe_allow_html=True)

...
if menu == "📦 Operacional":
  with _sub_op[1]:
    ...
    if len(st.session_state.estoque) == 0:
        ...
        st.caption("Adicione quantos produtos precisar: herbicida, fungicida, adjuvante, óleo, etc.")
        ...
        for i in range(n_produtos):
            ...
            _obs_p = col_p5.text_input("Obs.",      placeholder="adjuvante, sequência...", key=f"txt_obs_prod_{i}")
